...
adata = anndata.read("/home/disk400G/zlg/earlywarning/CPT_GRN_analysis-main/E1M2T_result/cancer_loom_E1M2T_processed.h5ad")
...
Parallel(n_jobs=100)(
    delayed(path_function)(0.01, 1e-1, i)
    for i in range(N))
